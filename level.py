        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                if val != "-1":
                    ...
                    if type == "tree":
                        if val == "0":
                            sprite = Tree(tile_size, x, y, "graphics/terrain/palm_small", 20)
                        if val == "1":
                            sprite = Tree(tile_size, x, y, "graphics/terrain/palm_large", 20)
    ...
    def player_setup(self, layout, change_health):
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == "14":
                    head_surface = pygame.image.load("graphics/character/head.png").convert_alpha()
                    head_surface = pygame.transform.scale(head_surface, (32, 32))
