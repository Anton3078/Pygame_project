...
class UI:
    ...
    def show_health(self, current, full):
        ...
        current_bar_width = current_health_ratio * self.bar_max_width
        health_bar_rect = pygame.Rect(self.health_bar_topleft,
    ...
    def show_coins(self, amount):
        ...
        coin_amount_rect = coin_amount_surf.get_rect(midleft=(self.coin_rect.right + 4,
