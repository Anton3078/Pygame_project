from settings import vertical_tile_number, screen_width, tile_size, screen_height
import pygame
...
class Sky:
    def __init__(self, horizon, style="level"):
        self.top = pygame.image.load("graphics/decoration/sky/BackGrount.png").convert()
        ...
        if self.style == "overworld":
            ...
            self.clouds = []
            for surface in [choice(cloud_surface) for _ in range(10)]:
